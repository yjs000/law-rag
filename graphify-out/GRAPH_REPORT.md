...
## Corpus Check
- 602 files · ~501,240 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8013 nodes · 15739 edges · 531 communities (441 shown, 90 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 1267 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d76928da`
...
## Communities (531 total, 90 thin omitted)
...
### Community 1 - "changed_provision_ids"
Cohesion: 0.30
Nodes (13): changed_provision_ids(), Return new or changed provisions by comparing canonical passage hashes., build_passage_text(), compute_source_text_sha256(), test_changed_provision_ids_includes_content_changed_rows(), test_changed_provision_ids_includes_new_and_changed_only(), ProvisionRecord, _record() (+5 more)

### Community 2 - "publish_prepared_bundle"
Cohesion: 0.17
Nodes (25): publish_prepared_bundle(), Path, Validate, gate, drain and atomically publish a prepared corpus update., _bundle(), _Connection, asyncio, Exception, parametrize (+17 more)
...
Cohesion: 0.09
Nodes (47): RawResponse, plan_provision_sync(), ProvisionRecord, raw_object_path(), _corpus_gate_call_indices(), _deletion_repository(), _DeletionConnection, _DeletionEngine (+39 more)
...
Cohesion: 0.10
Nodes (47): korea_today(), Return the product's legal-current date, independent of server timezone., _arguments(), _article_contexts(), _article_root(), _atomic_publish_run(), _atomic_write_query_cache(), _cache_file_sha256() (+39 more)

### Community 9 - "postgres_repository.py"
Cohesion: 0.08
Nodes (32): Corpus 항목 상태 조회를 v1 저장소에 위임한다., _async_url(), _corpus_items(), _corpus_search_status(), _corpus_temporal_population_statement(), _corpus_temporal_state(), _dense_search_parameters(), _dense_search_statement() (+24 more)

### Community 10 - "test_experiment_d_gold_preflight.py"
Cohesion: 0.07
Nodes (71): embedding_text_sha256(), EmbeddingProfile, legal_provision_embedding_text(), Build the versioned passage text used for provision embeddings., load_provisions(), load_provisions_from_connection(), AsyncConnection, Current-parser corpus records used by Experiment D validation and retrieval. (+63 more)
...
Cohesion: 0.14
Nodes (37): BundleState, _atomic_write(), _build_manifest(), _canonical_json(), _changes(), CorpusUpdateBundle, CorpusUpdateChanges, CorpusUpdateCounts (+29 more)

### Community 13 - "MemoryLegalRepository"
Cohesion: 0.09
Nodes (36): _date_or_none(), MemoryLegalRepository, date, Path, UUID, test_quota_resets_on_next_day(), asyncio, Path (+28 more)
...
Cohesion: 0.12
Nodes (29): _elapsed_ms(), _match_score(), _natural_trace(), datetime, Keep the highest-ranked leaf for each document/article pair., _stage_trace(), _unique_article_hits(), _anchored_query() (+21 more)
...
### Community 19 - "question_scope_set_sha256"
Cohesion: 0.11
Nodes (49): _arguments(), _artifact_name(), atomic_write_worklist(), build_pilot_worklist(), create_pilot_worklist(), _file_sha256(), _load_json_object(), main() (+41 more)

### Community 20 - "test_experiment_d_gold_contract.py"
Cohesion: 0.12
Nodes (42): canonical_gold_case_payload_sha256(), ExperimentDGoldCase, ExperimentDGoldDataset, Hash one complete validated gold-case payload using canonical JSON., _append_direct_supported_facet(), _case(), _corpus_snapshot(), _dataset() (+34 more)
...
Cohesion: 0.07
Nodes (30): _check_quota(), _check_v2_quota(), MockUser, BaseSettings, model_validator, Settings, main(), 0025 M5 item 6: bounded hosted smoke test for real NVIDIA answer generation.… (+22 more)
...
Cohesion: 0.13
Nodes (38): DraftAnswer, BaseModel, 구조 검증만 한다: 인용 ID가 실제 제공된 근거를 가리키는지, action별로 요구되는 필드가 채워졌는지. 문장 내용이 근거와 의미적으로…, validate_draft(), _draft_from_dict(), _hit_from_dict(), main(), 검증기(validate_draft) 코드를 고친 뒤 실제 근거·draft로 재검증한다 - 새 NVIDIA 호출 0회. 2026-08-08… (+30 more)

### Community 29 - "corpus.py"
Cohesion: 0.06
Nodes (42): changes(), corpus_status(), health(), provision(), date, get, post, Request (+34 more)
...
Cohesion: 0.09
Nodes (24): ApprovalManifestSourceBank, ApprovedQuestion, canonical_gold_corpus_snapshot_id(), ExperimentDGoldAdjudicationManifest, GoldAdjudicatedCase, GoldAnnotationProtocol, GoldAnnotationReview, GoldAsOfPopulation (+16 more)
...
Cohesion: 0.18
Nodes (33): Corpus 검색 상태 조회를 v1 저장소에 위임한다., run_and_publish_approved_gold(), FakeBackend, FakeEmbedder, _fixed_clock(), gold_bundle(), GoldFixtureBundle, PublisherSpy (+25 more)
...
Cohesion: 0.09
Nodes (45): Readable stages for the v2 LlamaIndex ingestion pipeline., _changed_provisions(), GenerationIngestionService, _has_unchanged_source(), IncrementalIngestionService, IngestionResult, _mark_generation_failed(), _node_counts() (+37 more)

### Community 37 - "client.py"
Cohesion: 0.14
Nodes (26): _clean(), _date(), DeletionPage, DeletionRecord, _first(), _json_records(), parse_deletions_json(), parse_deletions_xml() (+18 more)
...
Cohesion: 0.07
Nodes (44): build_checkpointer_context(), _psycopg_database_url(), Settings, get_settings(), BaseSettings, Settings, test_build_checkpointer_context_normalizes_url_and_returns_context_manager(), test_build_checkpointer_context_requires_database_url() (+36 more)
...
Cohesion: 0.09
Nodes (48): NvidiaNimAnswerer, Any, QuestionRoute, NVIDIA hosted NIM adapter with a schema-validated legal answer boundary., 0046: 사전 라우팅이 legal_search 밖으로 걸러낸 질문(embedding·검색 없음)에 근거 없이 LLM을 호출한다 -…, Release the process-owned NVIDIA HTTP client., build_blocked_route_messages(), build_core_messages() (+40 more)

### Community 45 - "ROADMAP.md"
Cohesion: 0.03
Nodes (55): 언제 더 읽어야 하는가, 이 파일을 갱신하는 시점, 지금 무엇이 진행 중인가, 현재 상태 (세션 시작 포인터), 활성 실행 계획, Task 1: ingestion 실행 lifecycle, Task 2: v2 HNSW 인덱스 운영 모듈, Task 3: API 지연 초기화 (+47 more)
...
Cohesion: 0.07
Nodes (39): _failure_kind(), NvidiaNimQuestionRouter, Any, BaseModel, Exception, Release the process-owned NVIDIA HTTP client., Question router backed by one structured NVIDIA NIM request., _RouteJudgmentSchema (+31 more)

### Community 57 - "get_settings"
Cohesion: 0.09
Nodes (26): get_settings(), do_run_migrations(), run_async_migrations(), _arguments(), Namespace, 계정 질문 이력의 검색 단계별 진단을 읽기 전용 JSON으로 출력한다., _run(), _arguments() (+18 more)
...
Cohesion: 0.28
Nodes (17): RetrievalState, _candidates(), _code_provenance(), FakeBackend, FakeEmbedder, FakeLockedReader, _provision(), _provisions() (+9 more)
...
### Community 65 - "LegalDocumentRecord"
Cohesion: 0.31
Nodes (5): CollectorRepository, Any, date, Protocol, LegalDocumentRecord

### Community 66 - "SupabaseAuthError"
Cohesion: 0.09
Nodes (27): AsyncClient, Exception, UUID, SupabaseAuth, SupabaseAuthError, SupabaseAuthUnavailableError, SupabaseIdentity, asyncio (+19 more)

### Community 67 - "CorpusSnapshot"
Cohesion: 0.09
Nodes (12): CorpusSnapshot, DenseCandidate, ExperimentDBackend, LockedDenseReader, Any, date, Protocol, _candidate() (+4 more)

### Community 68 - "validate_for_activation"
Cohesion: 0.18
...
Cohesion: 0.17
Nodes (22): _json_mapping(), PostgresQuestionExecutionRepository, AsyncEngine, datetime, ExecutionStatus, UUID, Atomically commit a completed phase and its replayable event log., Short-transaction PostgreSQL implementation; provider calls remain outside this… (+14 more)
...
Cohesion: 0.06
Nodes (31): LlamaIndexLegalRepository, date, datetime, UUID, v2 LlamaIndex 검색과 v1 저장소 위임을 결합한다., 단일 조문 조회를 v1 저장소에 위임한다., Corpus 기준일 범위 상태 조회를 v1 저장소에 위임한다., 마지막 corpus 동기화 시각 조회를 v1 저장소에 위임한다. (+23 more)

### Community 77 - "ingest.py"
Cohesion: 0.09
Nodes (26): Compatibility facade and CLI for the v2 LlamaIndex ingestion pipeline. The…, Read changed rows, replace their vectors and record the terminal run state., Normalize a shared database URL for the sync PGVectorStore engine., _sync_database_url(), copy_generation_vectors(), delete_nodes(), existing_hashes(), _finish_ingestion_run() (+18 more)
...
Cohesion: 0.10
Nodes (23): PhaseResult, datetime, QuestionPhaseCoordinator, Authoritative, replay-safe v2 phase coordination. Provider work is supplied as…, Start exactly one phase or return its persisted authoritative replay., AnswerEvent, EventProtocolError, ValueError (+15 more)
...
### Community 85 - "prepared_publisher.py"
Cohesion: 0.10
Nodes (23): _apply_prepared_transaction(), _BoundEngine, _BoundTransactionContext, _chunks(), _embedding_source_sha256(), AsyncConnection, T, Publish one validated local corpus bundle during a bounded maintenance window. (+15 more)
...
### Community 93 - "experiment_search.py"
Cohesion: 0.21
Nodes (25): _ask(), _atomic_write(), _atomic_write_many(), _display_path(), _evaluate(), load_corpus(), _load_evaluation_cases(), _load_search_runs() (+17 more)
...
Cohesion: 0.12
Nodes (28): date, ValueError, Dynamic temporal contract for the currently searchable legal corpus. The…, Raised when a request falls outside the current dynamic corpus bounds., Return a supported date or fail before quota and provider work begins., require_supported_corpus_date(), UnsupportedCorpusDateError, _corpus_unready_http_error() (+20 more)
...
Cohesion: 0.08
Nodes (37): cancel_question_execution(), _capability_hash(), _execution_capability(), _not_ready_error(), prepare_question_execution(), _prepared_execution_response(), alias, Any (+29 more)
...
Cohesion: 0.11
Nodes (19): M0 — 질문 승인과 상태 감사, M3 — D-10 raw/R1 소표본 calibration — 완료(2026-08-07, v3 Gold 기준 재계산), M4.5 — 검색 전 질문 라우팅 — 진행 중([0028](0028-pre-retrieval-question-routing.md), 착수 2026-08-07), M5 — NVIDIA 답변 연결 — 완료(2026-08-08), M7 — 기존 활성 계획 합류와 해결, M8 — 설계 확정과 전체 검증, 검증과 롤백, 결정 로그 (+11 more)
...
Cohesion: 0.23
Nodes (14): client(), asyncio, fixture, LogCaptureFixture, MonkeyPatch, parametrize, TestClient, test_v2_readiness_closes_when_marker_connection_or_migration_is_unavailable() (+6 more)

### Community 125 - "GenerationCatalog"
Cohesion: 0.11
Nodes (15): GenerationCatalog, In-memory state model for the generation publish invariant. Production…, Register a fresh, unpublished vector generation., _ActiveResult, _ReadConnection, _ReadEngine, _record(), test_catalog_retires_older_rollback_generations() (+7 more)

### Community 126 - "MockCorpusRepository"
Cohesion: 0.19
...
Cohesion: 0.23
Nodes (7): MemoryQuestionExecutionRepository, datetime, ExecutionStatus, UUID, Persist a phase result and every public event under one lock. A provider call…, In-memory reference implementation of the authoritative execution contract., StoredQuestionExecution
...
### Community 136 - "law_xml.py"
Cohesion: 0.24
Nodes (20): _clean_text(), _raw_article_events(), parametrize, test_open_api_error_is_not_treated_as_empty_search(), clean_text(), direct_text(), element_text(), first_text() (+12 more)
...
### Community 141 - "test_search_experiment.py"
Cohesion: 0.33
...
### Community 142 - "_ConnectionContext"
Cohesion: 0.10
Nodes (7): _ConnectionContext, _Engine, _ExistingTableFailingQueryConnection, _MissingTableConnection, test_existing_hashes_distinguishes_missing_table_from_query_failure(), _VerificationConnection, _VerificationResult
...
### Community 145 - "LoadedSource"
Cohesion: 0.17
Nodes (19): _article_evidence_presence(), _article_root(), _cosine(), Embedder, _embedding_text(), evaluate_cases(), _expected_article_rank(), _expected_raw_rank() (+11 more)
...
Cohesion: 0.18
Nodes (19): Generation catalog models, persistence and publication policy., generation_source_records(), generation_table_name(), GenerationSource, provision_fingerprint(), UUID, Pure generation catalog values and transformation fingerprints., Fingerprint the transformation contract that defines vector compatibility. (+11 more)

### Community 151 - "sse.py"
Cohesion: 0.21
Nodes (16): core_question_execution(), finalize_question_execution(), alias, Header, post, Request, StreamingResponse, UUID (+8 more)

### Community 152 - "PostgresGenerationRepository"
Cohesion: 0.10
Nodes (18): PostgresGenerationRepository, AsyncEngine, UUID, Read the stored lineage required to select safe vector copies., Switch active pointer only if the candidate has been verified., Persist generation transitions using short, caller-owned transactions., Record a failed candidate while retaining the current active pointer., Atomically restore an explicitly retained rollback generation. (+10 more)

### Community 153 - "실행 계획 0017: 실험 B — NVIDIA NIM 두 문장 임베딩과 코사인 유사도"
Cohesion: 0.09
Nodes (27): 2048차원 NIM과 기존 512차원 계약 연결, 코사인 유사도, 512차원 embed 계약, L2 재정규화, live API 반복성 관찰, 2048→512 첫 prefix slicing, nvidia/nemotron-3-embed-1b, query·passage 입력 유형 (+19 more)
...
### Community 161 - "test_experiment_d_local_rerank.py"
Cohesion: 0.44
...
Cohesion: 0.03
Nodes (91): Reject a publishable core summary that names evidence it did not receive., validate_core_draft(), bind_app_dependencies(), Bind a non-production app factory's resources for one HTTP request., Restore the previous factory binding after a request completes., reset_app_dependencies(), Protocol, QueryEmbeddingCapability (+83 more)
...
### Community 170 - "completed/README.md"
Cohesion: 0.04
Nodes (42): 검증과 롤백, 결정 로그, 목적과 사용자 결과, 미결정과 차단 요소, 범위와 비범위, 실행 계획 0027: 실험 D-10-R1 로컬 재정렬, 완료 조건, 작업 TODO (+34 more)
...
### Community 180 - "ports/question_execution.py"
Cohesion: 0.12
...
Cohesion: 0.09
Nodes (25): 조문 전체 단위 청크, Markdown·JSON 원자 저장, law_json.parse_legal_document, 실험 A 일반 텍스트 청킹, ProvisionRecord, 텍스트 입력 어댑터, TODO와 에이전트 배정, UI 잔여 줄 제거 (+17 more)
...
Cohesion: 0.11
Nodes (22): 승인 gold 미실행 상태, 법령 코퍼스 생애주기, 현재 dense-only 계약, 평가와 실험 읽기, 근거 우선 검색과 답변, 5개 장 학습 구조, 학습 노트 통합, 현재 parser v3 계약 (+14 more)
...
### Community 213 - "main_module"
Cohesion: 0.07
Nodes (62): ConsentRequiredError, Exception, _authenticated_user(), _bearer_token(), _FactoryCompositionMain, main_module(), _optional_user(), Any (+54 more)

### Community 214 - "6. v1에서 LangChain/LangGraph/LlamaIndex 버전으로: 로직이 어떻게 바뀌었나"
Cohesion: 0.22
...
### Community 231 - "0046 기준 질문 파이프라인 지도 설계"
Cohesion: 0.25
...
### Community 232 - "RetrievalGeneration"
Cohesion: 0.17
Nodes (13): A candidate or published immutable vector generation., RetrievalGeneration, GenerationStateError, UUID, ValueError, Restore one retained rollback generation as the active pointer target., Raised when a generation transition would violate the publish contract., Return the active generation, if any has been published. (+5 more)
...
Cohesion: 0.11
Nodes (21): 로컬 corpus 원자 교체, 저작권법, 전기사업법, LawOpenApiClient, 실험 C 지정 장·조 로컬 벡터 검색, NVIDIA passage embedding, 신재생에너지법, 지정 장·조 구조 범위 (+13 more)
...
### Community 251 - "V2 LlamaIndex 검색(Retrieval) 파이프라인 구현 계획"
Cohesion: 0.11
...
### Community 308 - "test_corpus_update_bundle.py"
Cohesion: 0.32
Nodes (13): PreparedRawRecord, _document(), _publish_base_row(), date, Path, test_embedding_repair_alone_requires_the_embedding_stage(), test_loader_rejects_tampered_and_partial_bundles(), test_paths_and_embedding_shapes_are_rejected_before_manifest_publish() (+5 more)
...
### Community 357 - "test_ai_fallback.py"
Cohesion: 0.19
...
### Community 358 - "test_layperson_prompt_v2.py"
Cohesion: 0.22
...
Cohesion: 0.14
Nodes (14): 0030: D-10 전수 qrel과 사용자 adjudication, v3 추가 기록 — 2026-08-07 (완료 이후 정정), 검증, 결정 로그, 롤백, 목적과 사용자 결과, 미결정과 차단 요소, 범위 (+6 more)
...
### Community 371 - "NvidiaNimEmbedder"
Cohesion: 0.21
...
### Community 376 - "ExecutionStatus"
Cohesion: 0.13
Nodes (25): _admit_v2_provider_phase(), Acquire provider capacity before sending an SSE response when work will start., PhaseDeadline, datetime, ExecutionStatus, StrEnum, asyncio, fixture (+17 more)
...
### Community 382 - "openai_answerer.py"
Cohesion: 0.29
...
### Community 388 - "CorpusSearchUnavailableError"
Cohesion: 0.23
...
### Community 396 - "run_cli"
Cohesion: 0.26
Nodes (14): main(), _parser(), ArgumentParser, run_cli(), _safe_error(), CaptureFixture, MonkeyPatch, Path (+6 more)
...
Cohesion: 0.15
Nodes (13): test_content_snapshot_identity_does_not_include_the_calendar_date(), test_content_snapshot_identity_rejects_invalid_population_contracts(), current_corpus_snapshot_id(), Read the same current 11-field population identity used during preparation., canonical_corpus_population_fingerprint(), canonical_corpus_publish_snapshot_id(), canonical_corpus_snapshot_id(), _is_sha256() (+5 more)
...
### Community 425 - "test_postgres_identity.py"
Cohesion: 0.45
...
### Community 432 - "0060: V2 기준일 지원 상한을 한국 날짜 today로 동적 계산"
Cohesion: 0.25
...
### Community 438 - "evaluate_routing_fixture.py"
Cohesion: 0.31
Nodes (9): _build_router(), evaluate(), _load_env_local(), main(), Evaluate the single NVIDIA question router against a fixed fixture. The…, main(), Retry failed single-router fixture cases until they resolve or the cap is…, _record() (+1 more)
...
### Community 447 - "test_question_cancellation.py"
Cohesion: 0.44
...
### Community 450 - "PreparedProvisionRecord"
Cohesion: 0.27
Nodes (4): PreparedProvisionRecord, model_validator, ProvisionRecord, Self

### Community 451 - "test_api_route_registration.py"
Cohesion: 0.25
...
### Community 463 - "select_generation_hits"
Cohesion: 0.50
...
### Community 493 - "마일스톤과 체크리스트"
Cohesion: 0.33
Nodes (6): M0 — 계약·preflight, M1 — corpus와 judgment 작업표, M2 — annotation 초안, M3 — 사용자 review와 adjudication, M4 — Gold 봉인 — 완료, 마일스톤과 체크리스트

### Community 496 - "보존된 D-full 설계 — 현재 보류"
Cohesion: 0.40
Nodes (5): D-full 50문항 pilot, D-full 재활성화 시 실행 순서, D-full 전체 1,000문항, M2 — D-10 10문항 평가 계약 동결 — 완료, 보존된 D-full 설계 — 현재 보류

### Community 497 - "M6 — 실험 E-10: AI 답변 소표본 평가 — 계획 확정(2026-08-08, [0032](0032-experiment-e-10-ai-answer-evaluation.md))"
Cohesion: 0.40
Nodes (5): E0 — 외부 호출 없는 결정적 검사, M6 — 실험 E-10: AI 답변 소표본 평가 — 계획 확정(2026-08-08, [0032](0032-experiment-e-10-ai-answer-evaluation.md)), 보존된 D-full E1 — pilot 50문항, 보존된 D-full E2 — calibration 200문항, 보존된 D-full E3 — held-out test 800문항

### Community 498 - "GitHub 이슈와 PR 운영"
Cohesion: 0.40
...
### Community 500 - "0047: 추가 정보 재질문 루프 중복 제거 및 미답변 처리"
Cohesion: 0.33
Nodes (6): 0047: 추가 정보 재질문 루프 중복 제거 및 미답변 처리, 목표, 비범위, 승격 조건, 완료 조건, 포함 범위

### Community 501 - "0050: 질의 형식 엣지케이스 조사 및 회귀 테스트 뱅크 구축"
Cohesion: 0.33
Nodes (6): 0050: 질의 형식 엣지케이스 조사 및 회귀 테스트 뱅크 구축, 목표, 비범위, 승격 조건, 완료 조건, 포함 범위

### Community 502 - "_load_source"
Cohesion: 0.67
Nodes (4): _exact_record(), _load_source(), SourceSpec, test_historical_source_requires_the_requested_mst()
...
### Community 505 - "exhaustive cosine Top 3"
Cohesion: 0.50
Nodes (4): exhaustive cosine Top 3, exhaustive exact cosine 평가, HNSW 영구 제외, HNSW 영구 제외

### Community 506 - "M4 — 실험 D2: AI 입력 검색 문맥 확정 — 완료(2026-08-07)"
Cohesion: 0.50
Nodes (4): M4 — 실험 D2: AI 입력 검색 문맥 확정 — 완료(2026-08-07), raw/R1과 A/B는 서로 다른 축이다, `search-context-contract-v1` — 문서 동결(코드 동결 아님), 검증 무게 원칙 — 튜닝과 확정 산출물을 구분한다
...
- **Why does `PostgresLegalRepository` connect `PostgresLegalRepository` to `LegalDocumentRecord`, `main.py`, `evaluate_experiment_d_gold.py`, `postgres_repository.py`, `test_experiment_d_gold_preflight.py`, `SearchTrace`, `search_only_answer`, `memory_repository.py`, `PostgresExperimentDBackend`, `test_backfill_embeddings.py`, `SourceKind`, `get_settings`, `corpus.py`, `CorpusTemporalState`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `SourceKind` connect `SourceKind` to `publish_prepared_bundle`, `render_pdf`, `run.py`, `test_prepared_publisher_postgres.py`, `RawResponse`, `law_xml.py`, `postgres_repository.py`, `corpus_update_bundle.py`, `MemoryLegalRepository`, `test_search_experiment.py`, `test_question_timeout_budget.py`, `LawOpenApiClient`, `SearchHit`, `PostgresLegalRepository`, `main.py`, `client.py`, `law_rag_core/domain/schemas.py`, `QuestionRequest`, `law_json.py`, `test_corpus_update_bundle.py`, `RouteJudgment`, `test_question_cancellation.py`, `law_rag_collector/service.py`, `LegalDocumentRecord`, `validate_for_activation`, `SearchTrace`, `search_only_answer`, `AnswerEvent`, `test_backfill_embeddings.py`, `test_prepared_update.py`, `test_ai_fallback.py`, `test_layperson_prompt_v2.py`, `_load_source`, `MockCorpusRepository`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `SearchHit` connect `SearchHit` to `query/retriever.py`, `postgres_repository.py`, `MemoryLegalRepository`, `test_question_timeout_budget.py`, `memory_repository.py`, `corpus.py`, `main.py`, `law_rag_core/domain/schemas.py`, `QuestionRequest`, `SourceKind`, `RouteJudgment`, `test_question_cancellation.py`, `CorpusSnapshot`, `SearchTrace`, `search_only_answer`, `select_generation_hits`, `AnswerEvent`, `AgentState`, `phase_service.py`, `LegalRepository`, `test_ai_fallback.py`, `test_layperson_prompt_v2.py`, `v1/answering.py`, `openai_answerer.py`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
