...
상태: 완료(2026-08-18) — Vercel·Supabase·Google OAuth·현재 코퍼스 연결과 실제 서비스 연결을
사용자가 확인해 완료로 종료. 235개 연혁 이관, Storage 수명주기, Preview 상대 프록시 등 남은
TODO는 코드에 남아 있으나 별도 후속 작업으로 재등록될 때까지 이 계획 자체는 닫는다.
작성일: 2026-07-14
소유자: 사용자와 Codex
