...
- [0025: 승인 질문에서 근거 기반 AI 답변까지](0025-approved-questions-to-grounded-answer-roadmap.md) — M0~M3 완료(D-10 Gold sealed), M4 AI 입력 문맥 확정 전, M4.5는 [예정 작업 0028](../todo/0028-pre-retrieval-question-routing.md)에 등록
