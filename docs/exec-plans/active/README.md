...
- [0008: 4단계 검색 지연과 디버깅](0008-four-stage-retrieval-latency-and-debugging.md) — Production EXPLAIN 접근 대기
- [0012: 분산 질문 취소](0012-distributed-question-cancellation.md) — 운영 migration 승인 대기
- [0015: 질문 이력 보존 정리 작업](0015-history-retention-job.md) — 로컬 함수 계약 완료, Production scheduler 승인 대기
- [0017: 실험 B NVIDIA NIM 두 문장 임베딩과 유사도](0017-experiment-b-sentence-embeddings.md) — 계획 수정 완료, 구현 대기
