...
- 2026-08-05: 외부 호출이 없는 부모 표제·직접성 규칙을 먼저 검증하고 passage 재임베딩과 모델
  reranker는 범위에서 제외했다.
- 2026-08-05: 고정 v1 profile에서 `lay-energy-0346` 직접 근거가 8위에서 2위로 이동했고 확정 무관
  top 5는 5개에서 4개로 줄었다. 전체 hit@3·5는 6/10에서 7/10으로 변했다.
- 2026-08-05: 전체 confirmed known irrelevant@5는 28에서 18로 변했지만 새 미판정 top 5 후보가 9개라
  실제 전체 무관 후보 감소로 해석하지 않는다.
