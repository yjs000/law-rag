...
| [실험 D 1,000문항 평가](experiment-d-1000-evaluation.md) | 질문은행 생성·gold 주석 전 | BEIR qrels, labelled reference, 경계·대조·비교군과 수동 검토 계약 |
| [실험 D 일반 사용자 질문은행](experiment-d-layperson-question-bank.md) | 질문 검토 초안 | 자연어 질문 후보와 독립 gold 주석·평가 승격 경계 |
