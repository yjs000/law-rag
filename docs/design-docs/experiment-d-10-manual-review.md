...
- 2026-08-05: 실제 run과 Codex 검토를 사용자가 10/10 승인했고, 수동 hit@1/3/5/10은
  `0.6/0.6/0.6/0.7`, top 5 무관 후보는 28개로 확정했다. 후속 로컬 재정렬은 원본 D-10을 변경하지 않는
  별도 진단으로 수행한다.
