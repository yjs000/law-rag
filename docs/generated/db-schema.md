...
> 기준 시점: 2026-07-15
> 생성 기준: `apps/api/migrations/versions/0001_legal_corpus.py`, `0002_auth_and_history.py`, `0003_separate_auth_identity.py`
...
| `question_history` | 로그인 사용자 질문·응답과 1년 만료 시각 |
