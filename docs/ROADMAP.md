...
- [F-005 · Feature — V2 LlamaIndex 프레임워크 파이프라인 개편](design-docs/v2-llamaindex-framework-redesign.md) — 예외 집계·최종 답변·외부 호출 timeout·100명 동시접속 계약까지 승인, 아직 구현 전; 다음 행동: 별도 실행계획 작성
