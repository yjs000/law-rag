<!-- 생성 명령: python scripts/render_roadmap.py; 입력 메타데이터 digest: 30ef5151053c90e5a9eb4166004a87389bac8f9e06c558a09e02df04f396bd2c -->
...
- [F-006-B · Feature — F-006-B 대화형 clarification workflow Implementation Plan](exec-plans/active/0065-conversational-clarification-workflow.md) — 다음 행동: V2 transport·웹 continuation UX·완료 문서를 검증하고 별도 커밋으로 정리한다.
